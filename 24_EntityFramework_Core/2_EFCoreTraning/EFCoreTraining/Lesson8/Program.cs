...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        #region AsNoTracking
        {
            ...
            var kullanicilar = await eTicaretContext.Kullanicilar.AsNoTracking().ToListAsync();
        ...
        #region AsNoTrackingWithIdentityResolution
        {
            ...
            var kitaplar = await eTicaretContext.Kitaplar.Include(k => k.Yazarlar).AsNoTrackingWithIdentityResolution().ToListAsync();
        ...
        #region AsTracking
        {
            ...
            var kitaplar = await eTicaretContext.Kitaplar.AsTracking().ToListAsync();
        }
        #endregion
